...
const ServiceFeatures = ({ features, industries }) => {
        ...
        <div className="w-full xl:w-1/3 xl:pr-16">
          <div className="xl:sticky xl:top-8">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed mb-10">
              <p>
                Our service delivers <strong className="text-gray-900">comprehensive solutions</strong> designed to meet your specific business needs and drive measurable results.
              </p>
            </div>

            {/* Ideal For - Industry Cards */}
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 gap-3">
                  {displayIndustries.map((industry, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="bg-gray-50 rounded-lg p-3 hover:bg-red-50 hover:border-red-200 border border-gray-100 transition-all duration-300 group cursor-pointer"
                      >
